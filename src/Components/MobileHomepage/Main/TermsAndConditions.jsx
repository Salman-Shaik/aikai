...
export const TermsAndConditions = () => {
  return (
    <section className={"mobile-terms"}>
      <h2>
        <strong>Terms and Conditions</strong>
      </h2>

      <p>Welcome to A.I.K.A.I!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Lightmasters's Website, located at aikai.co.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use A.I.K.A.I if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing A.I.K.A.I, you agreed to use
        cookies in agreement with the Lightmasters's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Lightmasters and/or its licensors own the
        intellectual property rights for all material on A.I.K.A.I. All
        intellectual property rights are reserved. You may access this from
        A.I.K.A.I for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from A.I.K.A.I</li>
        <li>Sell, rent or sub-license material from A.I.K.A.I</li>
        <li>Reproduce, duplicate or copy material from A.I.K.A.I</li>
        <li>Redistribute content from A.I.K.A.I</li>
      </ul>
      ...
      <p>
        ...
        Lightmasters does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Lightmasters,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Lightmasters shall not be
      ...
      <p>
        Lightmasters reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Lightmasters a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Lightmasters; and (d) the link
      ...
      <p>
        ...
        e-mail to Lightmasters. Please include your name, your organization
      ...
      <p>
        No use of Lightmasters's logo or other artwork will be allowed for
