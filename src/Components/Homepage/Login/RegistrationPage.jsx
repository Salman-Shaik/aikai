...
export const RegistrationPage = ({setGotoRegisterPage, setGotoLoginPage}) => {
    ...
    const isFormInvalid = () => {
        let isInvalid = false;
        const isValidUsername = !!username.match("(?:[a-z0-9!#$%&'*+=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+=?^_`{|}~-]+)*|\"(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21\x23-\x5b\x5d-\x7f]|\\\\[\x01-\x09\x0b\x0c\x0e-\x7f])*\")@(?:(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?|\\[(?:(?:(2(5[0-5]|[0-4][0-9])|1[0-9][0-9]|[1-9]?[0-9]))\\.){3}(?:(2(5[0-5]|[0-4][0-9])|1[0-9][0-9]|[1-9]?[0-9])|[a-z0-9-]*[a-z0-9]:(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21-\x5a\x53-\x7f]|\\\\[\x01-\x09\x0b\x0c\x0e-\x7f])+)\\])");
    ...
    return <section className="register_page">
        ...
        <section className="user_details">
            <section className="personal_details">
                <input type="name" placeholder="Enter Full Name" className={`detail name ${nameError ? "error" : ""}`}
                       onChange={updateName}/>
                <input type="number" placeholder="Age" className={`detail age ${ageError ? "error" : ""}`}
                       onChange={updateAge}/>
            </section>
            ...
            <input type="text" placeholder="Enter Your Email" className={`detail email ${usernameError ? "error" : ""}`}
