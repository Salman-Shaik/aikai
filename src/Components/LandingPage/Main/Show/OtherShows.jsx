...
const createMiniShows = (shows, setCurrentShow, setCurrentShowId, setHomePageLoaded,setCurrentMenuItem) => {
    return shows.map((show, index) => {
        ...
        return <MiniShow posterPath={posterPath} title={title} setCurrentShowId={setCurrentShowId}
                         key={index} setHomePageLoaded={setHomePageLoaded} id={show.id} setCurrentMenuItem={setCurrentMenuItem}/>;
    });
};

const Component = ({className, otherShows, keyword, currentShowType, setCurrentShow, setCurrentShowId, setHomePageLoaded,setCurrentMenuItem}) => {
    return <section className={className}>
        ...
        {_.isEmpty(otherShows)
            ...
            : <section
                className="mini_shows">{createMiniShows(otherShows, setCurrentShow, setCurrentShowId, setHomePageLoaded,setCurrentMenuItem)}</section>}
    </section>;
};

export const OtherShows = ({keyword, className, showId, currentShowType, setCurrentShow, setCurrentShowId, homepageLoaded, setHomePageLoaded, setCurrentMenuItem}) => {
